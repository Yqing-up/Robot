...
const inputSources = ref([
  ...
  { id: 4, name: '腿部系统', status: 'online', data: '运动状态稳定，电池电量85%' },
  { id: 5, name: '手臂系统', status: 'offline', data: '系统离线' }
])
...
const processingResults = ref([
  ...
  { id: 3, type: '系统优化', confidence: 92, content: '手臂系统需要重新连接，其他系统运行正常', timestamp: Date.now() - 120000 }
])
...
const connectedSystems = ref([
  ...
  { id: 4, name: '腿部系统', status: 'connected', statusText: '已连接', latency: 5, dataVolume: '0.8KB/s' },
  { id: 5, name: '手臂系统', status: 'disconnected', statusText: '连接中断', latency: 999, dataVolume: '0KB/s' }
])
